...
namespace Final_exam_project.core.ApplicationService.Services.MensService
{
    public class SweatshirtsService : ISweatshirtsService
    {
        ...
        public Sweatshirts SearchSweatshirts(Sweatshirts sweatshirts)
        {
            throw new NotImplementedException();
        }
